...
Many types of waves are known to propagate in the ocean and textbooks (LeBlond and Mysak,1978; Pedlosky, 2003...) 
\cite{auclair17}
...
For pure imaginary wave-numbers now, the deep-blue surface looks like an horizontal hyperbolic-tangent-like surface. Figure \oldref{FigDispSolutions}.d shows that real and pure-imaginary boundary-dispersion surfaces are very close for small vertical wave-numbers and cannot be distinguished graphically. This is a consequence of the fact that the tangent and hyperbolic-tangent functions have similar first-order Taylor expansion (with respect to $\delta_z$ or $\delta_{z,i}$).\\
